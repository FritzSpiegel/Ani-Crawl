...
export interface ApiAnimeAnime extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Anime series and movies crawled from AniWorld';
    displayName: 'Anime';
    pluralName: 'animes';
    singularName: 'anime';
  };
  ...
  attributes: {
    altTitles: Schema.Attribute.JSON;
    canonicalTitle: Schema.Attribute.String & Schema.Attribute.Required;
    ...
    episodes: Schema.Attribute.Component<'anime.episode', true>;
    ...
    producers: Schema.Attribute.JSON;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'canonicalTitle'> & Schema.Attribute.Required;
    sourceUrl: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    yearEnd: Schema.Attribute.Integer;
    yearStart: Schema.Attribute.Integer;
  };
}
...
export interface ApiGenreGenre extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    animes: Schema.Attribute.Relation<'manyToMany', 'api::anime.anime'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiRecommendationRecommendation
  ...
  info: {
    description: 'Featured anime recommendations shown on the homepage';
  ...
  attributes: {
    ...
    title: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Schw\u00E4rzlers Empfehlungen'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
